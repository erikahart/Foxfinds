...
import { LayoutDashboard, PlusCircle, Package, Tags, CalendarCheck, MessageCircle, LogOut, Menu, X } from "lucide-react";
  ...
  return (
    <>
      ...
      <aside className="hidden w-60 flex-shrink-0 flex-col border-r border-line bg-paper-raised md:flex">
        <div className="border-b border-line px-5 py-5"><Brand /></div>
        <NavLinks />
        <Footer />
      </aside>
